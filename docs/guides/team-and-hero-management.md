...
- [Players API](../api-reference/players.md) — Controller and pawn reference
- [Heroes API](../api-reference/heroes.md) — Hero enum and data
- [Console Commands](../api-reference/console-commands.md) — ConVar manipulation
